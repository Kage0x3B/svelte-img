...
<div class="test-basic relative mb-16">
	...
	<div class="absolute inset-0 flex flex-col justify-center">
		<div class="mx-auto prose px-4 text-center prose-h1:text-white prose-p:text-white">
			<h1>svelte-img</h1>
			<div class="ml-2 badge font-mono text-xs badge-neutral">v{version}</div>
			<p>High-performance responsive/progressive images for SvelteKit.</p>
			<a class="btn btn-primary" href="https://github.com/Kage0x3B/svelte-img" target="_blank">
				<span class="iconify h-6 w-6 mdi--github"></span>
				VISIT GITHUB REPO
			</a>
		</div>
	</div>
...
<div class="mx-auto prose mb-8 px-4">
	<blockquote>
		Render the bare minimum, minimally invasive, LQIP-included HTML code to represent responsive images, served in
...
<Img class="cool kitty" src={cat} alt="Very meow" />`)}</code
	...
	<p>
		...
		widths at <code>avif/webp/jpg</code> formats, with an inline <code>base64</code> low-quality image placeholder (LQIP)
		background.
	</p>
</div>
...
>
	<div class="h-full w-full backdrop-blur-[20px]"></div>
</div>
...
<div class="test-run-param">
	<Img class="test-1px mx-auto mb-16 h-[32rem] w-full max-w-[1920px] object-cover" src={i2} alt="cat" />
</div>
...
<div class="mx-auto mb-16 h-[32rem] w-full max-w-[1920px]" style="background:{i2.img.lqip}"></div>
...
<div class="mx-auto prose mb-16 px-4">
	<blockquote>
		The <code>svelte-img</code> component tries, as much as possible, to be a drop-in replacement for the native
		HTML
		<code>{esc(`<img>`)}</code> tag.
	</blockquote>
	<p>
		Side-effects are kept to a minimum, so things should still work even without JavaScript. Try it - disable JS on
		this page and refresh, and check out the Lighthouse score too.
	</p>
	<p>
...
<footer class="flex h-96 w-full flex-col items-center justify-center gap-4 bg-neutral text-neutral-content">
	<div class="flex items-center">
		<span class="mr-2 iconify h-6 w-6 mdi--email"></span>
		<a class="link" href="mailto:moritz.hein@live.de">moritz.hein@live.de</a>
	</div>
	<div class="flex items-center">
		<span class="mr-2 iconify h-6 w-6 mdi--earth"></span>
		<a class="link" href="https://moritz.website">moritz.website</a>
	</div>
</footer>
